...
public interface UserMapper {
    @Insert("INSERT INTO wetechpractise" +
            "(cpNameSei,cpNameMei,cpNameSeiKana,cpNameMeiKana,cpAlphLastnmae,cpAlphFirstname,cpCountry,cpOtherCountry, cpsSex ,cpBirthDate,cpDenwa,cpPhone,cpShokugyoCode,cpKinmusakiName)" +
            " VALUES" +
